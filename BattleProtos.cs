...
namespace DSP_Battle
{
    class BattleProtos
    {
        ...
        public static void AddProtos()
        {
            ...
            ProtoRegistry.RegisterString("彩蛋1描述", "", "这种生物似乎是一种虫类，靠进食宇宙中的各种能量潮汐为生，同时还具有虫洞制造能力，一旦发现食物就会直接在附近建立虫洞。星际物流塔产生的能量潮汐让它变成了宇宙中的一座灯塔，能被这些生物轻易捕捉并视作食物来源。换言之，只要不建设星际物流塔，那个星系就不会受到它们的侵扰。但这显然行不通，不用星际物流塔将极大的延缓任务完成的速度，这是主脑不愿意看到的。看来我需要一些防御设施来保护星际物流塔。唉，本来还说抽空思考一下宇宙的终极答案的……");
            ProtoRegistry.RegisterString("彩蛋2描述", "", "穿甲弹的效率还是太低了，我得试试找到强力的替代品，最好是能产生更大的伤害。就目前的情况来看，硫酸是个不错的选择，我可以试着直接把他们投射向敌人。再怎么说他们也是实体生物，酸蚀也够他们喝一壶的。还好它们不是异形，不然就是够我喝一壶的了。\n 4011年1月  我发现虫洞永远在预警五分钟时才生成？要是我的磁轨炮无法瞄准，也许我可以做点什么...");
            ProtoRegistry.RegisterString("彩蛋3描述", "", "我还是把他们想的太简单了。随着产线扩张，物流塔的建设，他们的攻势越来越凶猛。大炮的覆盖范围有限，已经无法有效抵挡他们了。好在我这几天在B站上学会了造热核弹，把它发射上去肯定能解燃眉之急。至于怎么发射上去，那还真得研究研究了，炮管子实在是太细了，放不进去。赶快结束这一切吧，我还想去梦里数电子羊呢。\n 4396年4月43日  似乎虫子每破坏一座星际物流塔，下一次进攻就会被推迟。也许可以想办法获得更多的发展时间？");
            ProtoRegistry.RegisterString("彩蛋4描述", "", "热核导弹的杀伤力确实很大，但是发射也太慢了，我得研究研究怎么把热核导弹造成微缩版本塞进炮弹里面去，那不就既有杀伤力又有速度嘛。我可真是个天才！唉，你说我这天才为什么就不得伊卡拉姆妹妹的喜欢呢？我为她专门点亮了一片星系告白，但她居然说：“前天看到了小白兔，昨天是小鹿，今天是你。”这不是嘲讽我像个动物一样蠢吗。算了算了，不提了，女人只会影响我造戴森球的速度。\n 4509年22月7日  我发现这些虫子攻击不同星系的强度是独立的，进攻全新星系的虫群似乎会重新从最低强度开始...看来目前是不怎么需要怕矿星的安全性问题了。");
