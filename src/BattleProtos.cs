...
namespace DSP_Battle
{
    class BattleProtos
    {
        ...
        public static void AddProtos()
        {
            ...
            ProtoRegistry.RegisterString("遗物描述3-1", "", "每次击毁敌舰，获得额外的异星矩阵或异星元数据");
            ProtoRegistry.RegisterString("遗物描述3-2", "", "伊卡洛斯会不消耗燃料地持续获得能量回复，相当于核心功率的10%");
            ProtoRegistry.RegisterString("遗物描述3-3", "", "击毁敌舰时，基于敌舰强度获得沙土");
            ProtoRegistry.RegisterString("遗物描述3-4", "", "手动加速敌军来袭时，因加速而损失的预期矩阵掉落数减半");
            ProtoRegistry.RegisterString("遗物描述3-5", "", "立刻重置敌舰进攻的总计次，并给予一次重新调整难度的机会，不会占用圣物槽位");
            ProtoRegistry.RegisterString("遗物描述3-6", "", "生产芯片、量子芯片时，来自增产剂的增产或增速效果加强50%");
            ...
            ProtoRegistry.RegisterString("遗物名称带颜色0-0", "", "<color=#d2853d>吞噬者</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-1", "", "<color=#d2853d>蓝buff</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-2", "", "<color=#d2853d>女神之泪</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-3", "", "<color=#d2853d>坚固透镜</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-4", "", "<color=#d2853d>黑百合</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-5", "", "<color=#d2853d>虚空荆棘</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-6", "", "<color=#d2853d>京级巨炮</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-7", "", "<color=#d2853d>撕裂力场</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-8", "", "<color=#d2853d>饮血剑</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色0-9", "", "<color=#d2853d>五叶草</color>");

            ProtoRegistry.RegisterString("遗物名称带颜色1-0", "", "<color=#9040d0>凯旋</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-1", "", "<color=#9040d0>虚空爆发</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-2", "", "<color=#9040d0>能量涌动</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-3", "", "<color=#9040d0>敌对海域</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-4", "", "<color=#9040d0>三体</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-5", "", "<color=#9040d0>回声 II</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-6", "", "<color=#9040d0>能量迸发</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-7", "", "<color=#9040d0>活性炭 II</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-8", "", "<color=#9040d0>女妖面纱</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-9", "", "<color=#9040d0>骑士之誓</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色1-10", "", "<color=#9040d0>真实伤害</color>");
            ...
            ProtoRegistry.RegisterString("遗物名称带颜色2-12", "", "<color=#2080d0>强攻</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色2-13", "", "<color=#2080d0>无尽之刃</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色2-14", "", "<color=#2080d0>行窃预兆</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色2-15", "", "<color=#2080d0>引力碎裂</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色2-16", "", "<color=#2080d0>刚毅护盾</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色2-17", "", "<color=#2080d0>不朽之守护</color>");

            ProtoRegistry.RegisterString("遗物名称带颜色3-0", "", "<color=#30b530>劣质加工</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-1", "", "<color=#30b530>窃法之刃</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-2", "", "<color=#30b530>方舟反应堆</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-3", "", "<color=#30b530>掘墓人</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-4", "", "<color=#30b530>装</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-5", "", "<color=#30b530>复活币</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-6", "", "<color=#30b530>光刻机</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-7", "", "<color=#30b530>虚空折射</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-8", "", "<color=#30b530>矩阵雨</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-9", "", "<color=#30b530>开摆</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-10", "", "<color=#30b530>多动症 I</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-11", "", "<color=#30b530>活性炭 I</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-12", "", "<color=#30b530>灵动巨物</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-13", "", "<color=#30b530>聚能环 I</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-14", "", "<color=#30b530>阳间马达</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-15", "", "<color=#30b530>超级大脑</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-16", "", "<color=#30b530>虚空棱镜</color>");
            ProtoRegistry.RegisterString("遗物名称带颜色3-17", "", "<color=#30b530>荣誉晋升</color>");
