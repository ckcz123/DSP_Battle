...
{/*
    public class SpaceForceShip
    {
        ...
        public SpaceForceShip(BinaryReader r)
        {
        ...
        public SpaceForceShip(int gid, int stationId, int wormholeIndex, int enemyId, int countDown)
        {
            shipData = new ShipData();
